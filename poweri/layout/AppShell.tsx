// PowerI 受控 fork of components/AppShell.tsx — 上游为准，重放增量。仅 import 差异。
// 额外差异：router.replace("/") → router.replace(window.location.pathname)（3 处，保持当前路由挂载点，上游以 / 为根；/poweri 下避免被弹回 /）。
"use client";
